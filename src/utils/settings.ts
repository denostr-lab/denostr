...
export class SettingsStatic {
    ...
    public static loadSettings(path: string, fileType: SettingsFileTypes) {
        ...
        switch (fileType) {
            case SettingsFileTypes.json: {
                console.warn(
                    'settings.json is deprecated, please use a yaml file based on resources/default-settings.yaml',
                )
            ...
            default: {
                throw new Error(
                    'settings file was missing or did not contain .yaml or .json extensions.',
                )
            }
        }
    }
    ...
    public static createSettings(): Settings {
        ...
        const defaults = SettingsStatic.loadSettings(
            defaultsFilePath,
            SettingsFileTypes.yaml,
        )
