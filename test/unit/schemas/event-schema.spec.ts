...
describe("NIP-01", () => {
  ...
  describe("validate event schema", () => {
    beforeEach(() => {
      event = {
        "id":
          "fa4dd948576fe182f5d0e3120b9df42c83dffa1c884754d5e4d3b0a2f98a01c5",
        "pubkey":
        ...
        "content": "",
        "sig":
          "313a9b8cd68267a51da84e292c0937d1f3686c6757c4584f50fcedad2b13fad755e6226924f79880fb5aa9de95c04231a4823981513ac9e7092bad7488282a96",
      };
    });
    ...
    it("returns error if unknown key is provided", () => {
      ...
      expect(validateSchema(eventSchema)(event)).to.have.nested.property(
        "error.message",
    ...
    const cases = {
      id: [
        { message: "must be a string", transform: assocPath(["id"], null) },
        {
          ...
          transform: assocPath(["id"], "F".repeat(64)),
        },
        {
          message: "must only contain hexadecimal characters",
          transform: assocPath(["id"], "not hex"),
        },
        {
          message: "length must be 64 characters long",
          transform: assocPath(["id"], "f".repeat(65)),
        },
        {
          message: "length must be 64 characters long",
          transform: assocPath(["id"], "f".repeat(63)),
        },
        {
      ...
      pubkey: [
        ...
        {
          message: "must only contain lowercase characters",
          transform: assocPath(["pubkey"], "F".repeat(64)),
        },
        {
          message: "must only contain hexadecimal characters",
          transform: assocPath(["pubkey"], "not hex"),
        },
        {
          message: "length must be 64 characters long",
          transform: assocPath(["pubkey"], "f".repeat(65)),
        },
        {
          message: "length must be 64 characters long",
          transform: assocPath(["pubkey"], "f".repeat(63)),
        },
        {
          message: "is not allowed to be empty",
          transform: assocPath(["pubkey"], ""),
        },
      ...
      created_at: [
        {
          ...
          transform: assocPath(["created_at"], 1672295751103),
        },
        {
          message: "must be a number",
          transform: assocPath(["created_at"], null),
        },
        {
          message: "must be greater than or equal to 0",
          transform: assocPath(["created_at"], -1),
        },
        {
          message: "must be a multiple of 1",
          transform: assocPath(["created_at"], Math.PI),
        },
      ...
      kind: [
        ...
        {
          message: "must be greater than or equal to 0",
          transform: assocPath(["kind"], -1),
        },
        {
          message: "must be a multiple of 1",
          transform: assocPath(["kind"], Math.PI),
        },
      ...
      content: [
        {
          ...
          transform: assocPath(["content"], null),
        },
      ...
      sig: [
        ...
        {
          message: "must only contain lowercase characters",
          transform: assocPath(["sig"], "F".repeat(128)),
        },
        {
          message: "must only contain hexadecimal characters",
          transform: assocPath(["sig"], "not hex"),
        },
        {
          message: "length must be 128 characters long",
          transform: assocPath(["sig"], "f".repeat(129)),
        },
        {
          message: "length must be 128 characters long",
          transform: assocPath(["sig"], "f".repeat(127)),
        },
        {
          message: "is not allowed to be empty",
          transform: assocPath(["sig"], ""),
        },
      ...
      identifier: [
        {
          message: "must be a string",
          transform: assocPath(["tags", 0, 0], null),
        },
        {
          message: "length must be less than or equal to 255 characters long",
          transform: assocPath(["tags", 0, 0], " ".repeat(256)),
        },
        {
          message: "is not allowed to be empty",
          transform: assocPath(["tags", 0, 0], ""),
        },
      ],
      value: [
        {
          message: "must be a string",
          transform: assocPath(["tags", 0, 1], null),
        },
        {
