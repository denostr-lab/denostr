...
describe('Alternative', () => {
    describe('constructor', () => {
        it('throw error if field has punctuations', () => {
            expect(() => new Alternative('%', '=', 'value')).to.throw(
                Error,
                'Field is not valid',
            )
        })
        ...
        it('throw error if cond is not valid', () => {
            expect(() => new Alternative('field', '@', 'value')).to.throw(
                Error,
                'Cond is not valid',
            )
        })
        ...
        it('returns an Alternative if given valid fields', () => {
            expect(new Alternative('field', '=', 'value')).to.be.an.instanceOf(
                Alternative,
            )
        })
    })
    ...
    describe('test', () => {
        ...
        it('returns reason if field not present with rule field=value', () => {
            expect(new Alternative('field', '=', 'value').test({})).to.equal(
                'field: is missing',
            )
        })
        ...
        it('returns reason if field is present with rule field!', () => {
            expect(new Alternative('field', '!', '').test({ field: 'value' })).to
                .equal('field: is present')
        })
        ...
        it('returns reason if field not equals value with rule field=value', () => {
            expect(
                new Alternative('field', '=', 'value').test({ field: 'not value' }),
            ).to.equal('field: != value')
        })

        it('returns undefined if field equals value with rule field=value', () => {
            expect(new Alternative('field', '=', 'value').test({ field: 'value' })).to
                .be.undefined
        })
        ...
        it('returns reason if field is not an integer with rule field<value', () => {
            expect(
                new Alternative('field', '<', '0').test({ field: 'not an integer' }),
            ).to.equal('field: not an integer field')
        })
        ...
        it('returns reason if field is not an integer with rule field<value', () => {
            expect(new Alternative('field', '<', 'not an integer').test({ field: 1 }))
                .to.equal('field: not a valid integer')
        })
        ...
        it('returns undefined if field is same as value with rule field{value', () => {
            expect(new Alternative('field', '{', 'b').test({ field: 'b' })).to.equal(
                'field: is the same or ordered after b',
            )
        })

        it('returns undefined if field is ordered before value with rule field{value', () => {
            expect(new Alternative('field', '{', 'b').test({ field: 'a' })).to.be
                .undefined
        })

        it('returns reason if field is ordered after value with rule field{value', () => {
            expect(new Alternative('field', '{', 'b').test({ field: 'c' })).to.equal(
                'field: is the same or ordered after b',
            )
        })
    ...
    describe('encode', () => {
        it('returns encoded alternative field = value', () => {
            expect(new Alternative('field', '=', 'value').encode()).to.equal(
                'field=value',
            )
        })
        ...
        it('returns encoded alternative field=\\|&', () => {
            expect(new Alternative('field', '=', '\\|&').encode()).to.equal(
                'field=\\\\\\|\\&',
            )
        })
    })
    ...
    describe('decode', () => {
        ...
        it('throw error decoding value', () => {
            expect(() => Alternative.decode('value')).to.throw(
                Error,
                'value does not contain any operator',
            )
        })
    ...
    describe('from', () => {
        it('creates alternative rule with spaces "field = value"', () => {
            expect(Alternative.from('field = value').encode()).to.equal(
                'field=value',
            )
        })
    })
...
describe('Restriction', () => {
    describe('constructor', () => {
        it('throws if given alternatives list is empty', () => [
            expect(() => new Restriction([])).to.throw(
                Error,
                'Restriction must have some alternatives',
            ),
        ])
    })
    ...
    describe('test', () => {
        ...
        it('returns reasons given 2 false alternatives', () => {
            ...
            expect(new Restriction(alternatives).test(values)).to.equal(
