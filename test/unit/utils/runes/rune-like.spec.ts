...
describe('RuneLike', () => {
    describe('test', () => {
        ...
        it('returns false and reason if 1 restriction is false', () => {
            ...
            expect(new RuneLike(restrictions).test(values)).to.deep.equal([
                false,
                'reason',
            ])
            expect(restrictions[0].test).to.have.been.calledOnceWithExactly(values)
    ...
    describe('from', () => {
        ...
        it('returns rune-like given restrictions a=1', () => {
            ...
            expect(restrictionDecodeStub.firstCall).to.have.been.calledWithExactly(
                'a=1',
            )
        ...
        it('returns rune-like given restrictions a=1|b=2&c=3', () => {
            ...
            expect(restrictionDecodeStub.secondCall).to.have.been.calledWithExactly(
                '&c=3',
            )
