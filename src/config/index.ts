...
const Config = {
    ...
    MONGO_MIN_POOL_SIZE: Number(Deno.env.get('MONGO_MIN_POOL_SIZE') || 0),
    MONGO_MAX_POOL_SIZE: Number(Deno.env.get('MONGO_MAX_POOL_SIZE') || 3),
    MONGO_READ_REPLICA_ENABLED: Boolean(Deno.env.get('MONGO_READ_REPLICA_ENABLED')),
    MONGO_RR_MIN_POOL_SIZE: Number(Deno.env.get('MONGO_RR_MIN_POOL_SIZE') || 0),
    MONGO_RR_MAX_POOL_SIZE: Number(Deno.env.get('MONGO_RR_MAX_POOL_SIZE') || 3),
