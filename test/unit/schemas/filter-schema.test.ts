        ...
        const cases = {
            ...
            prefixOrId: [
                ...
                },
                {
                    ...
                    transform: assocPath(['ids', 0], 'not hex'),
                },
                {
                    message: 'is not allowed to be empty',
                    transform: assocPath(['ids', 0], ''),
                },
            ],
            authors: [
                {
            ...
            prefixOrAuthor: [
                ...
                {
                    message: 'must only contain hexadecimal characters',
                    transform: assocPath(['authors', 0], 'not hex'),
                },
                {
                    message: 'is not allowed to be empty',
                    transform: assocPath(['authors', 0], ''),
                },
            ],
            kinds: [
            ...
            kind: [
                {
                    ...
                    transform: assocPath(['kinds', 0], -1),
                },
                {
                    message: 'must be a number',
                    transform: assocPath(['kinds', 0], null),
                },
                {
                    message: 'must be a multiple of 1',
                    transform: assocPath(['kinds', 0], Math.PI),
                },
            ],
            since: [
                {
                    message: 'contains an invalid value',
                    transform: assocPath(['since'], 1672295751103),
                },
                { message: 'must be a number', transform: assocPath(['since'], null) },
                {
                    message: 'must be greater than or equal to 0',
                    transform: assocPath(['since'], -1),
                },
                {
                    message: 'must be a multiple of 1',
                    transform: assocPath(['since'], Math.PI),
                },
            ],
            until: [
                {
                    message: 'contains an invalid value',
                    transform: assocPath(['until'], 1672295751103),
                },
                { message: 'must be a number', transform: assocPath(['until'], null) },
                {
                    message: 'must be greater than or equal to 0',
                    transform: assocPath(['until'], -1),
                },
                {
                    message: 'must be a multiple of 1',
                    transform: assocPath(['until'], Math.PI),
                },
            ],
            limit: [
